...
export declare class MonacoEditorComponent implements OnInit, OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MonacoEditorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MonacoEditorComponent, "ngx-monaco-editor", never, { "options": "options"; "uri": "uri"; }, { "init": "init"; }, never, never>;
}
